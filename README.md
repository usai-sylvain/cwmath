...
if len(element_ids) > 0:
    ...
    xl = gc.get_xl(*element_ids)
    vec_u = cwvector3d.CwVector3d.from_point_3d(yl)
    vec_v = cwvector3d.CwVector3d.from_point_3d(xl)
    plane = cwplane3d.CwPlane3d(point1, vec_u, vec_v)
    print(point1)
    print(yl)
    print(plane)
